package com.rollcallsystem.MQTT;
...
import com.rollcallsystem.MainActivity.FirstActivity;
...
public class PushService extends Service
{
	...
	private static final String MQTT_HOST = "120.114.136.54";
	...
	public static String MQTT_CLIENT_ID = "Message";
	...
	// Preferences instance �x�s���n�]�w(Preference)
	...
	// �q���T�����D
	public static String NOTIF_TITLE = "Std";
	// �q���T��ID
	...
	public static void setMqttClient(IMqttClient mqttClient) {
		PushService.mqttClient = mqttClient;
	}
	...
	public static void actionStart(Context ctx) {
		...
		Log.i(TAG, "ACTION_START" + ACTION_START);
		ctx.startService(i);
	...
	public void onCreate() {
		...
		// Get instances of preferences, manager and notification manager
		// ������n �s���޲z & �q���޲z
		...
		/*
		 * If our process was reaped by the system for any reason we need to restore
		 * our state with merely a call to onCreate. We record the last "started"
		 * value and restore it here if necessary.
		 */
	...
	private void showNotification(String text) {
		...
		n.icon = R.drawable.title_bar;
		n.when = System.currentTimeMillis();

		// Simply open the parent activity
		PendingIntent pi = PendingIntent.getActivity(this, 0,
				new Intent(this, ClassDataUpdateActivity.class), 0);
